...
LD_LIBRARY_PATH="$ROOT/ObjcMarkdown/obj:$ROOT/third_party/libs-OpenSave/Source/obj:$ROOT/third_party/TextViewVimKitBuild/obj:$ROOT/third_party/GPUpdaterCore/obj:$ROOT/third_party/GPUpdaterUI/obj:/usr/GNUstep/System/Library/Libraries${LD_LIBRARY_PATH:+:$LD_LIBRARY_PATH}" \
exec "$APP_BIN" "$@"
